...
function handleSubmit(event) {
  ...
  const age = getInputedNumberValue('age');
  const weight = getInputedNumberValue('weight');
  const height = getInputedNumberValue('height');
...
function getInputedNumberValue(id) {
